...
public:
	...
	bool check_collision(const Vector2& position, const Vector2& size)//判断矩形相交逻辑
	{
...
private:
	Animation animation_idle;//ex炸弹默认动画
	Animation animation_explode;//ex炸弹爆炸动画
